...
To better understand why you would do vector optimization and how VOPy is helpful, please first check our `motivating example <examples/motivating_example.ipynb>`_.
